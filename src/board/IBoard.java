...
public interface IBoard {
     ...
     * @param y
     */
    void putShip(AbstractShip ship, int x, int y) throws ShipPosOutOfBoardError, ShipSuperpositionError;
     ...
     * @param y
     */
    void setHit(boolean hit, int x, int y) throws ShipStruckAtSamePosError;
     ...
     */
    Hit sendHit(int x, int y) throws ShipStruckAtSamePosError;
}
